...
describe SlackMoji::App do
  ...
  context '#deactivate_asleep_teams!' do
    ...
    it 'destroys teams inactive for two weeks' do
      expect_any_instance_of(Team).to receive(:inform!).with(
        text: "Your subscription expired more than 2 weeks ago, deactivating. Reactivate at #{SlackMoji::Service.url}. Your data will be purged in another 2 weeks."
      ).once
  ...
  context 'subscribed' do
    ...
    let(:plan) { stripe_helper.create_plan(id: 'moji-yearly', amount: 999) }
